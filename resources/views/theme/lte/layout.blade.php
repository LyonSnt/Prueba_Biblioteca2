<!DOCTYPE html>
    ...
    <title>@yield('titulo','Biblioteca') | Hoy 23</title>
              ...
              <aside class="main-sidebar sidebar-dark-primary elevation-4">
                ...
                <a href="{{asset("assets/$theme/index3.html")}}" class="brand-link">
                  <img src="{{asset("assets/$theme/dist/img/AdminLTELogo.png")}}"
                       ...
                       style="opacity: .8">
                  <span class="brand-text font-weight-light">JAAPARC</span>
                </a>
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                      ...
                      <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                          <li class="nav-item">
                            <a href="{{asset("assets/$theme/index.html")}}" class="nav-link">
                              <i class="far fa-circle nav-icon"></i>
                              <p>Dashboard v1</p>
                            </a>
                          </li>
                          <li class="nav-item">
                            <a href="{{asset("assets/$theme/index2.html")}}" class="nav-link">
                              <i class="far fa-circle nav-icon"></i>
                              <p>Dashboard v2</p>
                            </a>
                          </li>
                          <li class="nav-item">
                            <a href="{{asset("assets/$theme/index3.html")}}" class="nav-link">
                              <i class="far fa-circle nav-icon"></i>
                              <p>Dashboard v3</p>
                            </a>
                          </li>
                      ...
                      <li class="nav-item">
                        <a href="{{asset("assets/$theme/widgets.html")}}" class="nav-link">
                      ...
                      <li class="nav-item">
                        <a href="{{asset("assets/$theme/calendar.html")}}" class="nav-link">
